...
class GenericChatWidget extends StatefulWidget {
  ...
  @override
  State<GenericChatWidget> createState() => _GenericChatWidgetState();
}

class _GenericChatWidgetState extends State<GenericChatWidget> {
